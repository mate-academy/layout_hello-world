...
describe("legacy linter | id-style", function () {
    ...
    it("Should throw an error if `id-class-ignore-regex` is empty", function () {
        ...
        const html = '<div id="bar-2"></div>';
        (0, chai_1.expect)(() => linter.lint(html)).to.throw('Configuration for rule "id-class-ignore-regex" is invalid: You provide an empty string value');
    });
    ...
    it("should throw an error if rule config is empty", function () {
        ...
        (0, chai_1.expect)(() => linter.lint("")).to.throw('Configuration for rule "id-style" is invalid: "" is not accepted. Accepted values are "none", "lowercase", "underscore", "dash", "camel" and "bem"');
    });
    it("should throw an error if rule config is provided with an invalid format", function () {
        ...
        (0, chai_1.expect)(() => linter.lint("")).to.throw('Configuration for rule "id-style" is invalid: "foo" is not accepted. Accepted values are "none", "lowercase", "underscore", "dash", "camel" and "bem"');
    });
});
describe("id-style", function () {
    ...
    it("should throw an error if rule config is empty", function () {
        ...
        (0, chai_1.expect)(() => createLinter(config)).to.throw('Configuration for rule "id-style" is invalid: "" is not accepted. Accepted values are "none", "lowercase", "underscore", "dash", "camel" and "bem"');
    });
    it("should throw an error if rule config is provided with an invalid format", function () {
        const config = {
            "id-style": [true, "foo"]
        };
        (0, chai_1.expect)(() => createLinter(config)).to.throw('Configuration for rule "id-style" is invalid: "foo" is not accepted. Accepted values are "none", "lowercase", "underscore", "dash", "camel" and "bem"');
    });
});
